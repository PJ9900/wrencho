				...
				<div class="box box-info">
					<div class="box-body">
					 <!--   <div class="form-group">-->
						...
						<!--	<div class="col-sm-4">-->
						<!--		<select name="category" class="form-control select2 top-cat">-->
						<!--			<option value="">Select Category</option>-->
						<!--			<option value="0" <?php if($category == '0'){echo 'selected';} ?>>E-Rickshaw</option>-->
						<!--			<option value="1" <?php if($category == '1'){echo 'selected';} ?>>Two-Wheeler</option>-->
						<!--			<option value="2" <?php if($category == '2'){echo 'selected';} ?>>Other</option>-->
						<!--		</select>-->
						<!--	</div>-->
						<!--</div>-->
						<div class="form-group">
