...
if(isset($_POST['form1'])) {
    ...
    //     $error_message .= 'You must have to select a Category photo<br>';
        ...
        move_uploaded_file( $bpath_tmp,'assets/images/mid-category/'.$bpath); 
    //  if($_POST['banner']==''){
    //   $bpath=$_POST['obanner'];
    // }   
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_mid_category SET home_img=?,show_home=?,mcat_name=?,banner=?,tcat_id=?,meta_title=?,meta_keyword=?,meta_description=?,slug=?,content_add=? WHERE mcat_id=?");
		$statement->execute(array($final_name,$_POST['show_on_home'],$_POST['mcat_name'],$bpath,$_POST['tcat_id'],$_POST['mtitle'],$_POST['mkey'],$_POST['mdescr'],$slug,$_POST['description'],$_REQUEST['id']));  
                ...
                <div class="form-group">
                	...
                	<div class="form-group">
							...
							<div class="col-sm-4" style="padding-top:5px">
								<img src="assets/images/mid-category/<?php echo $banner; ?>" alt="Category Image" style="width:400px;">
							</div>
						</div>
						<div class="form-group">
