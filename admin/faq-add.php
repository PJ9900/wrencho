...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_faq (faq_title,faq_content,rating) VALUES (?,?,?)");
		$statement->execute(array($_POST['faq_title'],$_POST['faq_content'],$_POST['rating']));
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="number" autocomplete="off" class="form-control" name="rating" value="<?php if(isset($_POST['rating'])){echo $_POST['rating'];} ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<!-- <input type="text" autocomplete="off" class="form-control" name="faq_content" value="<?php if(isset($_POST['faq_content'])){echo $_POST['faq_content'];} ?>"> -->
